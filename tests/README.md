...
|-------------------------------|-----------|--------------------------------------------------------|
| toll-management-service-java  | JUnit 5   | `services/toll-management-service-java/src/test/java/` |
...
- **Categories**:
  ...
  - `toll-management-service/` — Transaction CRUD and cache behavior
  - `end-to-end/` — Full transaction correction flow
