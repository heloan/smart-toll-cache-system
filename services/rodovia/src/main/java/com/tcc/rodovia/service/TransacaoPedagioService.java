...
import com.tcc.rodovia.repository.TransacaoPedagioRepository;
    ...
    private List<TransacaoPedagioResponseDTO> convertMapListToDTO(List<Map<String, Object>> mapList) {
        ...
        return mapList.stream()
                .map(map -> {
                    ...
                    dto.setTipoVeiculo(com.tcc.rodovia.enums.TipoVeiculoEnum.valueOf((String) map.get("tipoVeiculo")));
